...
type: skill
category: frontend
description: Create reusable React components aligned with project patterns.
when_to_use: When performing tasks related to react component create.
do_not_use_when: When the task falls outside this domain or requires a different skill entirely.
risk_level: medium
owner_agents: [react-specialist, frontend-specialist]
...
## Purpose
Create reusable React components aligned with project patterns.

## When to Use
Use this skill when tasked with executing a react component create operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve react component create, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for react component create.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the react component create operation safely.
...
## Checklist
- [ ] Understand the exact goal of the react component create request.
...
## Example Usage
*Scenario:* An agent is tasked with react component create.
