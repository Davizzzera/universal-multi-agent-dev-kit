...
type: skill
category: frontend
description: Validate and improve layouts across desktop, tablet and mobile.
when_to_use: When performing tasks related to responsive layout audit.
do_not_use_when: When the task falls outside this domain or requires a different skill entirely.
risk_level: medium
owner_agents: [responsive-layout-specialist, frontend-specialist]
...
## Purpose
Validate and improve layouts across desktop, tablet and mobile.

## When to Use
Use this skill when tasked with executing a responsive layout audit operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve responsive layout audit, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for responsive layout audit.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the responsive layout audit operation safely.
...
## Checklist
- [ ] Understand the exact goal of the responsive layout audit request.
...
## Example Usage
*Scenario:* An agent is tasked with responsive layout audit.
