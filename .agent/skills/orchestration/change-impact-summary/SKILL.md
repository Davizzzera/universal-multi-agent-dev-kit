---
name: change-impact-summary
type: skill
category: orchestration
description: Summarize the impact of proposed or completed changes.
when_to_use: When performing tasks related to change impact summary.
do_not_use_when: When the task falls outside this domain or requires a different skill entirely.
risk_level: medium
owner_agents: [final-reviewer, technical-lead, documentation-writer]
...
## Purpose
Summarize the impact of proposed or completed changes.

## When to Use
Use this skill when tasked with executing a change impact summary operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve change impact summary, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for change impact summary.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the change impact summary operation safely.
...
## Checklist
- [ ] Understand the exact goal of the change impact summary request.
...
## Example Usage
*Scenario:* An agent is tasked with change impact summary.
