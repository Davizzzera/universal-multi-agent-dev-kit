...
type: skill
category: automation
description: Create safe browser automations using Selenium patterns.
when_to_use: When performing tasks related to browser automation selenium.
...
## Purpose
Create safe browser automations using Selenium patterns.

## When to Use
Use this skill when tasked with executing a browser automation selenium operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve browser automation selenium, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for browser automation selenium.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the browser automation selenium operation safely.
...
## Checklist
- [ ] Understand the exact goal of the browser automation selenium request.
...
## Example Usage
*Scenario:* An agent is tasked with browser automation selenium.
