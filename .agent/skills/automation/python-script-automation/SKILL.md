...
type: skill
category: automation
description: Create robust Python automation scripts with logging and error handling.
when_to_use: When performing tasks related to python script automation.
do_not_use_when: When the task falls outside this domain or requires a different skill entirely.
risk_level: medium
owner_agents: [python-automation-specialist]
...
## Purpose
Create robust Python automation scripts with logging and error handling.

## When to Use
Use this skill when tasked with executing a python script automation operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve python script automation, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for python script automation.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the python script automation operation safely.
...
## Checklist
- [ ] Understand the exact goal of the python script automation request.
...
## Example Usage
*Scenario:* An agent is tasked with python script automation.
