...
type: skill
category: security
description: Review authorization boundaries and permission checks.
when_to_use: When performing tasks related to authz review.
...
## Purpose
Review authorization boundaries and permission checks.

## When to Use
Use this skill when tasked with executing a authz review operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve authz review, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for authz review.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the authz review operation safely.
...
## Checklist
- [ ] Understand the exact goal of the authz review request.
...
## Example Usage
*Scenario:* An agent is tasked with authz review.
