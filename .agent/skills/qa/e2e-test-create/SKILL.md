...
## When to Use
Use this skill when tasked with executing a e2e test create operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve e2e test create, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for e2e test create.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the e2e test create operation safely.
...
## Checklist
- [ ] Understand the exact goal of the e2e test create request.
...
## Example Usage
*Scenario:* An agent is tasked with e2e test create.
