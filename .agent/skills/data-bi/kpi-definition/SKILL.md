...
type: skill
category: data-bi
description: Define clear metrics, formulas, ownership and interpretation rules.
when_to_use: When performing tasks related to kpi definition.
...
## Purpose
Define clear metrics, formulas, ownership and interpretation rules.

## When to Use
Use this skill when tasked with executing a kpi definition operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve kpi definition, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for kpi definition.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the kpi definition operation safely.
...
## Checklist
- [ ] Understand the exact goal of the kpi definition request.
...
## Example Usage
*Scenario:* An agent is tasked with kpi definition.
