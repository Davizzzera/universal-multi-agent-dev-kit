...
type: skill
category: context
description: Extract business rules, product behavior and operational logic from docs or code.
when_to_use: When performing tasks related to business context extraction.
do_not_use_when: When the task falls outside this domain or requires a different skill entirely.
risk_level: medium
owner_agents: [business-analyst, requirements-engineer, product-manager]
...
## Purpose
Extract business rules, product behavior and operational logic from docs or code.

## When to Use
Use this skill when tasked with executing a business context extraction operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve business context extraction, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for business context extraction.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the business context extraction operation safely.
...
## Checklist
- [ ] Understand the exact goal of the business context extraction request.
...
## Example Usage
*Scenario:* An agent is tasked with business context extraction.
