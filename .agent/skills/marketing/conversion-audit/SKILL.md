...
type: skill
category: marketing
description: Audit pages or flows for conversion friction and improvement opportunities.
when_to_use: When performing tasks related to conversion audit.
do_not_use_when: When the task falls outside this domain or requires a different skill entirely.
risk_level: medium
owner_agents: [growth-specialist, landing-page-strategist]
...
## Purpose
Audit pages or flows for conversion friction and improvement opportunities.

## When to Use
Use this skill when tasked with executing a conversion audit operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve conversion audit, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for conversion audit.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the conversion audit operation safely.
...
## Checklist
- [ ] Understand the exact goal of the conversion audit request.
...
## Example Usage
*Scenario:* An agent is tasked with conversion audit.
