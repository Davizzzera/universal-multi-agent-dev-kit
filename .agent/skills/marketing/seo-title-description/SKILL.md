...
type: skill
category: marketing
description: Create SEO titles, meta descriptions and search-oriented snippets.
when_to_use: When performing tasks related to seo title description.
do_not_use_when: When the task falls outside this domain or requires a different skill entirely.
risk_level: medium
owner_agents: [seo-specialist, copywriter]
...
## Purpose
Create SEO titles, meta descriptions and search-oriented snippets.

## When to Use
Use this skill when tasked with executing a seo title description operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve seo title description, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for seo title description.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the seo title description operation safely.
...
## Checklist
- [ ] Understand the exact goal of the seo title description request.
...
## Example Usage
*Scenario:* An agent is tasked with seo title description.
