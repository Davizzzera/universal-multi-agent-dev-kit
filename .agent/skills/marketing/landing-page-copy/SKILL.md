...
type: skill
category: marketing
description: Create landing page copy aligned with offer, audience and conversion.
when_to_use: When performing tasks related to landing page copy.
do_not_use_when: When the task falls outside this domain or requires a different skill entirely.
risk_level: medium
owner_agents: [copywriter, landing-page-strategist]
...
## Purpose
Create landing page copy aligned with offer, audience and conversion.

## When to Use
Use this skill when tasked with executing a landing page copy operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve landing page copy, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for landing page copy.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the landing page copy operation safely.
...
## Checklist
- [ ] Understand the exact goal of the landing page copy request.
...
## Example Usage
*Scenario:* An agent is tasked with landing page copy.
