---
name: cta-copywriting
type: skill
category: marketing
description: Create clear, specific and conversion-focused calls to action.
when_to_use: When performing tasks related to cta copywriting.
do_not_use_when: When the task falls outside this domain or requires a different skill entirely.
risk_level: medium
owner_agents: [copywriter, growth-specialist]
...
## Purpose
Create clear, specific and conversion-focused calls to action.

## When to Use
Use this skill when tasked with executing a cta copywriting operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve cta copywriting, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for cta copywriting.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the cta copywriting operation safely.
...
## Checklist
- [ ] Understand the exact goal of the cta copywriting request.
...
## Example Usage
*Scenario:* An agent is tasked with cta copywriting.
