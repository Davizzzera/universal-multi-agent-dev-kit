...
type: skill
category: marketing
description: Create strong first-fold messaging for landing pages or product pages.
when_to_use: When performing tasks related to hero copywriting.
...
## Purpose
Create strong first-fold messaging for landing pages or product pages.

## When to Use
Use this skill when tasked with executing a hero copywriting operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve hero copywriting, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for hero copywriting.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the hero copywriting operation safely.
...
## Checklist
- [ ] Understand the exact goal of the hero copywriting request.
...
## Example Usage
*Scenario:* An agent is tasked with hero copywriting.
