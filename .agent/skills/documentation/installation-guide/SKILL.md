...
description: Document installation and setup steps clearly.
when_to_use: When performing tasks related to installation guide.
do_not_use_when: When the task falls outside this domain or requires a different skill entirely.
risk_level: medium
owner_agents: [documentation-writer, technical-writer]
...
## Purpose
Document installation and setup steps clearly.

## When to Use
Use this skill when tasked with executing a installation guide operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve installation guide, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for installation guide.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the installation guide operation safely.
...
## Checklist
- [ ] Understand the exact goal of the installation guide request.
...
## Example Usage
*Scenario:* An agent is tasked with installation guide.
