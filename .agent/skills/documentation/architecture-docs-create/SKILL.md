---
name: architecture-docs-create
type: skill
category: documentation
description: Document architecture, components and design decisions.
when_to_use: When performing tasks related to architecture docs create.
do_not_use_when: When the task falls outside this domain or requires a different skill entirely.
risk_level: medium
owner_agents: [technical-writer, software-architect]
...
## Purpose
Document architecture, components and design decisions.

## When to Use
Use this skill when tasked with executing a architecture docs create operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve architecture docs create, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for architecture docs create.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the architecture docs create operation safely.
...
## Checklist
- [ ] Understand the exact goal of the architecture docs create request.
...
## Example Usage
*Scenario:* An agent is tasked with architecture docs create.
