...
type: skill
category: ui-ux
description: Improve clarity, placement and conversion strength of calls to action.
when_to_use: When performing tasks related to cta optimization.
...
## Purpose
Improve clarity, placement and conversion strength of calls to action.

## When to Use
Use this skill when tasked with executing a cta optimization operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve cta optimization, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for cta optimization.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the cta optimization operation safely.
...
## Checklist
- [ ] Understand the exact goal of the cta optimization request.
...
## Example Usage
*Scenario:* An agent is tasked with cta optimization.
