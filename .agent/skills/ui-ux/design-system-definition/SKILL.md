...
type: skill
category: ui-ux
description: Define reusable visual standards, tokens and component rules.
when_to_use: When performing tasks related to design system definition.
do_not_use_when: When the task falls outside this domain or requires a different skill entirely.
risk_level: medium
owner_agents: [design-system-specialist, ui-ux-designer]
...
## Purpose
Define reusable visual standards, tokens and component rules.

## When to Use
Use this skill when tasked with executing a design system definition operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve design system definition, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for design system definition.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the design system definition operation safely.
...
## Checklist
- [ ] Understand the exact goal of the design system definition request.
...
## Example Usage
*Scenario:* An agent is tasked with design system definition.
