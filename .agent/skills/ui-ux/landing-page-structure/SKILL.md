...
type: skill
category: ui-ux
description: Plan high-conversion landing page sections and message hierarchy.
when_to_use: When performing tasks related to landing page structure.
do_not_use_when: When the task falls outside this domain or requires a different skill entirely.
risk_level: medium
owner_agents: [landing-page-strategist, copywriter, ui-ux-designer]
...
## Purpose
Plan high-conversion landing page sections and message hierarchy.

## When to Use
Use this skill when tasked with executing a landing page structure operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve landing page structure, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for landing page structure.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the landing page structure operation safely.
...
## Checklist
- [ ] Understand the exact goal of the landing page structure request.
...
## Example Usage
*Scenario:* An agent is tasked with landing page structure.
