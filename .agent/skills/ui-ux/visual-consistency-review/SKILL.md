...
type: skill
category: ui-ux
description: Check visual alignment, spacing, typography, color usage and component consistency.
when_to_use: When performing tasks related to visual consistency review.
do_not_use_when: When the task falls outside this domain or requires a different skill entirely.
risk_level: medium
owner_agents: [design-system-specialist, visual-regression-specialist]
...
## Purpose
Check visual alignment, spacing, typography, color usage and component consistency.

## When to Use
Use this skill when tasked with executing a visual consistency review operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve visual consistency review, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for visual consistency review.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the visual consistency review operation safely.
...
## Checklist
- [ ] Understand the exact goal of the visual consistency review request.
...
## Example Usage
*Scenario:* An agent is tasked with visual consistency review.
