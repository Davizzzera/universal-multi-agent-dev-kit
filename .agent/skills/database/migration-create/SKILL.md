...
type: skill
category: database
description: Create safe, versioned and reversible database migrations.
when_to_use: When performing tasks related to migration create.
do_not_use_when: When the task falls outside this domain or requires a different skill entirely.
risk_level: medium
owner_agents: [migration-specialist, database-specialist]
...
## Purpose
Create safe, versioned and reversible database migrations.

## When to Use
Use this skill when tasked with executing a migration create operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve migration create, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for migration create.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the migration create operation safely.
...
## Checklist
- [ ] Understand the exact goal of the migration create request.
...
## Example Usage
*Scenario:* An agent is tasked with migration create.
