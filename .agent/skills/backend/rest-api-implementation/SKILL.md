...
when_to_use: When performing tasks related to rest api implementation.
...
## Purpose
Implement REST API endpoints following project conventions.

## When to Use
Use this skill when tasked with executing a rest api implementation operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve rest api implementation, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for rest api implementation.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the rest api implementation operation safely.
...
## Checklist
- [ ] Understand the exact goal of the rest api implementation request.
...
## Example Usage
*Scenario:* An agent is tasked with rest api implementation.
