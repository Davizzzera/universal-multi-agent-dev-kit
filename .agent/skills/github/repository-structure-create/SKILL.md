---
name: repository-structure-create
type: skill
category: github
description: Create or improve repository structure and organization.
when_to_use: When performing tasks related to repository structure create.
do_not_use_when: When the task falls outside this domain or requires a different skill entirely.
risk_level: medium
owner_agents: [github-repository-manager, technical-lead]
...
## Purpose
Create or improve repository structure and organization.

## When to Use
Use this skill when tasked with executing a repository structure create operation to ensure consistency and correctness.

## When Not to Use
Do not use this skill if the task does not involve repository structure create, or if a more specific alternative skill exists.
...
## Procedure
1. Analyze the request and identify the specific requirements for repository structure create.
2. Review existing patterns or codebase constraints before taking action.
3. Formulate a plan to execute the repository structure create operation safely.
...
## Checklist
- [ ] Understand the exact goal of the repository structure create request.
...
## Example Usage
*Scenario:* An agent is tasked with repository structure create.
