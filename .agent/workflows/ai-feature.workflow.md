...
name: ai-feature
type: workflow
description: Design, implement and validate AI-powered features, prompts, agents, RAG systems or LLM workflows.
trigger: ["AI feature", "LLM", "prompt", "agent", "RAG", "chatbot", "embeddings", "multi-agent"]
primary_agent: universal-orchestrator
required_agents: ["ai-engineer", "prompt-engineer", "qa-tester", "final-reviewer"]
optional_agents: ["agent-engineer", "rag-specialist", "security-reviewer", "privacy-compliance-reviewer", "documentation-writer", "backend-specialist"]
required_skills: ["prompt-architecture", "agent-definition", "subagent-definition", "multi-agent-orchestration", "rag-pipeline-design", "llm-output-evaluation", "hallucination-check style review if applicable", "privacy-data-exposure-review if applicable"]
...
# Workflow Purpose
Design, implement and validate AI-powered features, prompts, agents, RAG systems or LLM workflows.

## Important Behavior
- AI outputs must not be treated as verified facts without grounding.
- RAG systems must define source grounding.
- Prompt outputs must define structure and evaluation criteria.
- Privacy and data exposure must be reviewed.
...
- **Required Agents:** ai-engineer, prompt-engineer, qa-tester, final-reviewer
- **Optional Agents:** agent-engineer, rag-specialist, security-reviewer, privacy-compliance-reviewer, documentation-writer, backend-specialist
...
- hallucination-check style review if applicable
- privacy-data-exposure-review if applicable

# Execution Steps
1. **Trigger Reception**: The Orchestrator identifies the user intent mapping to the `ai-feature` workflow.
...
# Example Run
*User Request:* "Please perform a ai feature operation."
