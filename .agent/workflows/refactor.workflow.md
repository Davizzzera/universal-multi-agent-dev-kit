...
trigger: ["refactor", "clean up", "simplify", "improve code structure", "remove duplication"]
primary_agent: universal-orchestrator
required_agents: ["project-context-reader", "scope-guardian", "conflict-controller", "refactor-specialist", "qa-tester", "final-reviewer"]
optional_agents: ["technical-lead", "codebase-analyst", "frontend-specialist", "backend-specialist", "performance-engineer"]
required_skills: ["existing-patterns-detection", "codebase-map", "implementation-plan", "code-review-checklist", "duplicate-code-detection", "technical-debt-detection", "regression-test-checklist", "build-validation"]
...
- Any behavior change must be explicitly reported and approved.
- Tests or regression checks are mandatory.
...
- **Required Agents:** project-context-reader, scope-guardian, conflict-controller, refactor-specialist, qa-tester, final-reviewer
- **Optional Agents:** technical-lead, codebase-analyst, frontend-specialist, backend-specialist, performance-engineer
...
# Execution Steps
1. **Trigger Reception**: The Orchestrator identifies the user intent mapping to the `refactor` workflow.
...
# Example Run
*User Request:* "Please perform a refactor operation."
