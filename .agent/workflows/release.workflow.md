...
name: release
type: workflow
description: Prepare versioning, changelog, release notes and final readiness for a repository release.
trigger: ["release", "version", "changelog", "tag", "publish version", "prepare release"]
primary_agent: release-manager
required_agents: ["changelog-maintainer", "final-reviewer", "qa-tester", "security-reviewer"]
optional_agents: ["documentation-writer", "github-repository-manager", "devops-specialist"]
required_skills: ["semantic-versioning", "changelog-update", "conventional-commits", "release notes template usage", "security-release-checklist", "production-readiness-check", "validation-report creation"]
...
# Workflow Purpose
Prepare versioning, changelog, release notes and final readiness for a repository release.

## Important Behavior
- Do not release unvalidated changes.
- Changelog must match actual commits and files.
...
- **Required Agents:** changelog-maintainer, final-reviewer, qa-tester, security-reviewer
- **Optional Agents:** documentation-writer, github-repository-manager, devops-specialist

# Skills Involved
- semantic-versioning
- changelog-update
- conventional-commits
- release notes template usage
- security-release-checklist
- production-readiness-check
- validation-report creation

# Execution Steps
1. **Trigger Reception**: The Orchestrator identifies the user intent mapping to the `release` workflow.
...
# Example Run
*User Request:* "Please perform a release operation."
