...
name: debug
type: workflow
description: Investigate, reproduce and resolve bugs with minimal, evidence-based changes.
trigger: ["debug", "fix bug", "error", "broken", "not working", "investigate issue"]
primary_agent: universal-orchestrator
required_agents: ["project-context-reader", "task-router", "scope-guardian", "bug-hunter", "final-reviewer", "qa-tester"]
optional_agents: ["frontend-specialist", "backend-specialist", "database-specialist", "devops-specialist", "security-reviewer", "performance-engineer"]
required_skills: ["codebase-map", "existing-patterns-detection", "task-breakdown", "test-plan-create", "regression-test-checklist", "error-message-review", "build-validation", "change-impact-summary"]
...
# Workflow Purpose
Investigate, reproduce and resolve bugs with minimal, evidence-based changes.

## Important Behavior
- Reproduce or reason from evidence before changing code.
- Prefer minimal fixes.
- Do not rewrite unrelated code.
- Clearly document root cause and fix.
...
- **Required Agents:** project-context-reader, task-router, scope-guardian, bug-hunter, final-reviewer, qa-tester
- **Optional Agents:** frontend-specialist, backend-specialist, database-specialist, devops-specialist, security-reviewer, performance-engineer
...
# Execution Steps
1. **Trigger Reception**: The Orchestrator identifies the user intent mapping to the `debug` workflow.
...
# Example Run
*User Request:* "Please perform a debug operation."
