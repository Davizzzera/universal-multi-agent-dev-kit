...
type: workflow
description: Perform a defensive security review of code, configuration, dependencies, data handling and release readiness.
trigger: ["security review", "audit security", "check vulnerabilities", "review secrets", "harden project"]
primary_agent: security-reviewer
required_agents: ["secrets-scanner", "dependency-security-auditor", "final-reviewer"]
optional_agents: ["auth-security-reviewer", "privacy-compliance-reviewer", "backend-specialist", "devops-specialist", "database-specialist"]
required_skills: ["secrets-detection", "dependency-vulnerability-check", "input-sanitization", "authz-review", "secure-logging-review", "security-release-checklist", "environment-variable-management"]
...
# Workflow Purpose
Perform a defensive security review of code, configuration, dependencies, data handling and release readiness.

## Important Behavior
- Defensive only.
- Do not provide offensive exploitation instructions.
- Do not reveal secrets.
- Focus on safe remediation and hardening.
...
- **Required Agents:** secrets-scanner, dependency-security-auditor, final-reviewer
- **Optional Agents:** auth-security-reviewer, privacy-compliance-reviewer, backend-specialist, devops-specialist, database-specialist
...
# Execution Steps
1. **Trigger Reception**: The Orchestrator identifies the user intent mapping to the `security-review` workflow.
...
# Example Run
*User Request:* "Please perform a security review operation."
