...
name: verify
type: workflow
description: Verify that the repository, feature or implementation actually works before claiming completion.
trigger: ["verify", "validate", "check if it works", "confirm implementation", "run validation"]
primary_agent: final-reviewer
required_agents: ["qa-tester", "project-context-reader"]
optional_agents: ["security-reviewer", "devops-specialist", "documentation-writer", "visual-regression-specialist", "dependency-security-auditor"]
required_skills: ["build-validation", "regression-test-checklist", "manual-test-checklist", "acceptance-validation", "security-release-checklist", "documentation-review", "change-impact-summary"]
...
# Workflow Purpose
Verify that the repository, feature or implementation actually works before claiming completion.

## Important Behavior
- Do not claim success without evidence.
- If validation cannot be run, explain why.
- Report commands, outputs or manual checklist evidence.
...
# Agents Involved
- **Primary Agent:** final-reviewer
- **Required Agents:** qa-tester, project-context-reader
- **Optional Agents:** security-reviewer, devops-specialist, documentation-writer, visual-regression-specialist, dependency-security-auditor
...
# Execution Steps
1. **Trigger Reception**: The Orchestrator identifies the user intent mapping to the `verify` workflow.
...
# Example Run
*User Request:* "Please perform a verify operation."
