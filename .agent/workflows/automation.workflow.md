...
name: automation
type: workflow
description: Design, implement and validate automation scripts, file processors, n8n flows or browser automations.
trigger: ["automation", "automate", "script", "n8n", "webhook automation", "file watcher", "browser automation"]
primary_agent: universal-orchestrator
required_agents: ["python-automation-specialist", "qa-tester", "final-reviewer"]
optional_agents: ["n8n-automation-specialist", "webhook-specialist", "integration-specialist", "security-reviewer", "devops-specialist", "documentation-writer"]
required_skills: ["python-script-automation", "n8n-workflow-design", "n8n-webhook-flow", "browser-automation-playwright", "browser-automation-selenium", "error-retry-strategy", "reporting-automation", "secure-logging-review"]
...
# Workflow Purpose
Design, implement and validate automation scripts, file processors, n8n flows or browser automations.

## Important Behavior
- Avoid hardcoded credentials.
- Include logging, retries and error handling.
- Destructive file operations require explicit approval.
- Automation must be explainable and recoverable.
...
- **Required Agents:** python-automation-specialist, qa-tester, final-reviewer
- **Optional Agents:** n8n-automation-specialist, webhook-specialist, integration-specialist, security-reviewer, devops-specialist, documentation-writer
...
# Execution Steps
1. **Trigger Reception**: The Orchestrator identifies the user intent mapping to the `automation` workflow.
...
# Example Run
*User Request:* "Please perform a automation operation."
