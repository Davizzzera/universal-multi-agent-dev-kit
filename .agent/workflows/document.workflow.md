...
name: document
type: workflow
description: Create, update or validate documentation so it matches actual repository behavior.
trigger: ["document", "update docs", "README", "write guide", "explain architecture", "create documentation"]
primary_agent: documentation-writer
required_agents: ["technical-writer", "final-reviewer"]
optional_agents: ["software-architect", "github-repository-manager", "product-manager", "qa-tester"]
required_skills: ["readme-create", "installation-guide", "usage-guide", "architecture-docs-create", "troubleshooting-guide", "folder-structure-docs", "changelog-update", "documentation-review"]
...
# Workflow Purpose
Create, update or validate documentation so it matches actual repository behavior.

## Important Behavior
- Documentation must not invent features.
- Documentation must match actual repository behavior.
- TODO sections must be explicit.
...
- **Required Agents:** technical-writer, final-reviewer
- **Optional Agents:** software-architect, github-repository-manager, product-manager, qa-tester

# Skills Involved
- readme-create
- installation-guide
- usage-guide
- architecture-docs-create
...
# Execution Steps
1. **Trigger Reception**: The Orchestrator identifies the user intent mapping to the `document` workflow.
...
# Example Run
*User Request:* "Please perform a document operation."
